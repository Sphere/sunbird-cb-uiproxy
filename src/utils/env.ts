...
export const CONSTANTS = {
  ...
  NOTIFICATION_ENGINE_API_BASE:
    env.NOTIFICATION_ENGINE_API_BASE || 'http://localhost:3013',
  ...
  PIPE_LINE_USER_ID:
    env.PIPE_LINE_USER_ID || '8dc9f708bd144d78b2e423f7be1bcd8a',
  ...
  DHURVA_BHASHINI_API_BASE:
    env.DHURVA_BHASHINI_API_BASE || 'https://dhruva-api.bhashini.gov.in',
  MEITY_AUTH_ULCACONTRIB:
    env.MEITY_AUTH_ULCACONTRIB || 'https://meity-auth.ulcacontrib.org',
  ...
  PORTAL_CASSANDRA_CONSISTENCY_LEVEL:
    env.PORTAL_CASSANDRA_CONSISTENCY_LEVEL || 'one',
  CASSANDRA_REPLICATION_FORM: env.CASSANDRA_REPLICATION_FORM || 3,
  PORTAL_AUTH_SERVER_URL:
    env.PORTAL_AUTH_SERVER_URL || 'https://sphere.aastrika.org/auth',
};
