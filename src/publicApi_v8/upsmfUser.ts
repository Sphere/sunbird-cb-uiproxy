...
// sonar-cleanup: local getUserDetails/createUser/assignRoleToUser/OTP-axios-calls/migrateUserToUpsmf replaced with shared imports (CHANGE 30)
import {
...
const createUser = async (userDetails: UserDetails) =>
    createOrgSignupUser(userDetails, 'upsmf', (details) => getDetailsAsPerRole(details).orgName)
